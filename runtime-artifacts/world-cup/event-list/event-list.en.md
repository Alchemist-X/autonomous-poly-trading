# 2026 World Cup Public Forecasts — Event List & Resolution Definitions

> Generated: 2026-06-11T12:29:01.335Z · Source: cached Polymarket Gamma snapshot (event structure and resolution mapping only; this pipeline is market-blind — the analysis never reads market prices)

**Scope:** 72 group-stage matches + 12 group winners + quarterfinalists + semifinalists + champion — 87 questions, 408 market legs.

## Resolution Definitions (uniform across all questions)
...
## 1. Group-Stage Matches (72)

| # | Date | Grp | Fixture | Kickoff (UTC) | event_slug |
|---|---|---|---|---|---|
...
## 3. Quarterfinalists (48 teams, alphabetical)
