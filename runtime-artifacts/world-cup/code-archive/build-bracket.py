...
MC = json.load(open('runtime-artifacts/world-cup/mc-results.json'))['teams']
...
bracket["standings"] = {g: {"1st": firsts[g], "2nd": seconds[g], "3rd": thirds[g] + (" (晋级)" if g in qualified else " (出局)")} for g in sorted(GROUPS)}
