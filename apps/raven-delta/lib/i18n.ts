...
export const DICT = {
  ...
  heroTitle: ["News that matters. Impact in minutes.", "最有价值的新闻，对市场意味着什么。"],
  heroSub: [
    "Paste the news. Raven Delta verifies it, pins down when it first appeared, maps 0-5 impacted US stocks, and tells you what to do — pushed to email and WebSocket.",
    "粘贴新闻原文。Raven Delta 自行核实、标出全网最早出现时间，映射 0-5 只受影响美股并给出操作——邮件与 WebSocket 即时推送。"
  ],
  ...
  textLabel: ["News text", "新闻原文"],
  textHelp: ["Just paste — headline, alert, or the whole article. Verification is our job, not yours.", "直接粘贴——标题、快讯或全文都行。核实是引擎的事，不用你声明来源。"],
  ...
  timingBasisLabel: ["Timing basis", "时间依据"],
  staleWarning: ["over 24h old — likely priced in", "已超过 24 小时——大概率已被定价"],
  originalLink: ["Original link", "原文链接"],
  noUrl: ["No URL provided", "未提供 URL"],
