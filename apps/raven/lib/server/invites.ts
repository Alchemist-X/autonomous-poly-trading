// Invite-code store shared by the raven web app and the forecast API through the
// artifacts volume (mirror of services/forecast-api/src/invites.ts). Event-sourced: an append-only JSONL of create/revoke/use
