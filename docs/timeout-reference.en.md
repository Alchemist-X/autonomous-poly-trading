...
| Services that still keep finite timeouts | `orchestrator` Pulse web-search / external fetches, `orchestrator` resolution jobs, `rough-loop` provider/verification/git/doctor |
